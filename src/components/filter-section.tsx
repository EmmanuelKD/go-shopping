        ...
        <div className="border-b border-gray-200">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden h-full lg:flex relative">
                {/* Mega menus */}
                <Popover.Group className="ml-8 relative">
                  <div className="flex h-full justify-center space-x-8">
                    ...
                    {navigation.categories.map((category, categoryIdx) => (
                      <Popover key={category.name} className="flex  w-full ">
                        {({ open }) => (
                          <>
                            ...
                            >
                              <Popover.Panel className="absolute lg:w-[1000px] inset-x-0 top-full text-gray-500 sm:text-sm z-50">
                ...
                <Tab.Group as="div" className="mt-2">
                  ...
                  <Tab.Panels as={Fragment}>
                    {navigation.categories.map((category, categoryIdx) => (
                      <Tab.Panel
                        key={category.name}
                        className="space-y-12 px-4 pb-6 pt-10  z-40"
                      >
